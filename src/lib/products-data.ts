...
export const products: Product[] = [
  {
    ...
    standardSizes: ['1MVA', '2.5MVA', '5MVA', '10MVA', '16MVA', '25MVA', '40MVA'],
    ...
    productDescription: '专为工业、发电厂和变电站应用设计的大容量油浸式电力变压器，符合 IEC 60076 标准，性能稳定可靠。',
    descriptionBullets: [
      { zh: '符合 IEC 60076 电力变压器标准', en: 'IEC 60076 Power Transformer Standard' },
      { zh: '电压等级 10kV–66kV，容量 1MVA–40MVA', en: 'Voltage 10kV–66kV, Capacity 1MVA–40MVA' },
      { zh: '大型散热器与油浸式绝缘结构，适合连续负载运行', en: 'Large Radiators and Oil-Immersed Insulation for Continuous Operation' },
      { zh: '适用于变电站、电厂升压和大型工业配电项目', en: 'For Substations, Power Plants and Large Industrial Distribution' },
    ],
    detailedSpecTable: {
      columns: [
        { key: 'capacity_mva', label: '容量', unit: 'MVA' },
        { key: 'hv_kv', label: '高压', unit: 'kV' },
        { key: 'lv_kv', label: '低压', unit: 'kV' },
        { key: 'freq_hz', label: '频率', unit: 'Hz' },
        { key: 'cooling', label: '冷却方式' },
        { key: 'standards', label: '标准' },
      ],
      rows: [
        { capacity_mva: 1, hv_kv: '10~35', lv_kv: '0.4~10.5', freq_hz: 50, cooling: 'ONAN', standards: 'IEC 60076' },
        { capacity_mva: 2.5, hv_kv: '10~35', lv_kv: '0.4~10.5', freq_hz: 50, cooling: 'ONAN / ONAF', standards: 'IEC 60076' },
        { capacity_mva: 5, hv_kv: '10~35', lv_kv: '6.3~10.5', freq_hz: 50, cooling: 'ONAN / ONAF', standards: 'IEC 60076' },
        { capacity_mva: 10, hv_kv: '35~66', lv_kv: '6.3~10.5', freq_hz: 50, cooling: 'ONAN / ONAF', standards: 'IEC 60076' },
        { capacity_mva: 16, hv_kv: '35~66', lv_kv: '6.3~10.5', freq_hz: 50, cooling: 'ONAN / ONAF', standards: 'IEC 60076' },
        { capacity_mva: 25, hv_kv: '35~66', lv_kv: '6.3~10.5', freq_hz: 50, cooling: 'ONAN / ONAF', standards: 'IEC 60076' },
        { capacity_mva: 40, hv_kv: '35~66', lv_kv: '6.3~10.5', freq_hz: 50, cooling: 'ONAN / ONAF', standards: 'IEC 60076' },
      ],
      note: '以上为常用油浸式电力变压器范围，实际电压、容量、联结组和冷却方式可按项目要求定制。',
    },
  },
  {
  ...
  },
  {
    ...
    fullDescription: '杆上式变压器是为架空配电线路设计的紧凑型轻量化设备，广泛用于农村电气化、末端供电和公用配电网络，在用电点实现中压至低压的可靠降压。',
  ...
  },
  {
    ...
    standardSizes: ['315kVA', '500kVA', '630kVA', '800kVA', '1000kVA', '1250kVA', '1600kVA'],
    image: '/images/products/compact-substation.webp',
    detailImage: '/images/products/compact-substation.webp',
    specs: {
      voltage: '6kV–35kV / 0.4kV',
      capacity: '315kVA – 2,500kVA',
      frequency: '50Hz / 60Hz',
      cooling: 'AN / ONAN',
    ...
    descriptionBullets: [
      ...
      { zh: '容量覆盖 315–2500kVA', en: 'Capacity Range from 315 to 2500kVA' },
    ...
    detailedSpecTable: {
      ...
      rows: [
        { label: '额定容量',     value: '315kVA / 500kVA / 630kVA / 800kVA / 1000kVA / 1250kVA / 1600kVA / 2500kVA' },
        { label: '高压侧电压',   value: '6kV、10kV、11kV、20kV、33kV、35kV 或定制' },
        { label: '低压侧电压',   value: '0.4kV 或定制' },
...
export function getProductBySlug(slug: string) {
  const legacySlugs: Record<string, string> = {
    'oil-immersed-transformer': 'power-transformer',
    'distribution-transformer': 'oil-immersed-distribution-transformer',
  }

  return products.find(p => p.id === (legacySlugs[slug] ?? slug))
}
