...
function createProductFaq(productName: string, applicableStandards: string): ProductFaqItem[] {
  return [
    ...
    },
    {
      ...
      answer: 'Voltage ratio and tapping requirements can be reviewed against the project specification. The final design is subject to the approved technical agreement.',
    },
    {
      question: 'Are copper and aluminum windings available?',
      answer: 'Winding conductor options depend on the product rating, design review and project requirements. Please identify the preferred conductor in the inquiry.',
    },
    {
    ...
    },
    {
      ...
      answer: 'Available technical documents depend on the final project specification and contract requirements.',
    },
    {
      question: 'How is the transformer packed for export?',
      answer: 'The packing method is selected according to the equipment configuration, transport route and agreed contract requirements.',
    },
  ]
}
...
export const products: Product[] = [
  {
    ...
    seoDescription: 'Oil immersed distribution transformers for utility, industrial and commercial distribution projects, configured to approved project requirements.',
    ...
    productDescription: '适用于住宅、商业、工业及农村配电项目，额定电压 6–11 kV，容量 30–2500 kVA，二次电压 0.4 kV。',
    descriptionBullets: [
    ...
    faq: createProductFaq('Oil Immersed Distribution Transformer', 'IEC 60076 or applicable project requirements'),
    ...
    detailedSpecTable: {
      ...
      rows: [
        { capacity_kva: 30,   hv_kv: '6–11', lv_kv: 0.4, freq_hz: 50, connection: 'Dyn11 / Yyn0', no_load_loss_w: 80,   load_loss_w: '630/600',   no_load_current_pct: 0.5,  noise_db: 43, impedance_pct: 4.0, spec_ab_mm: '400×400', size_mm: '830×650×950',   weight_kg: 380 },
        { capacity_kva: 50,   hv_kv: '6–11', lv_kv: 0.4, freq_hz: 50, connection: 'Dyn11 / Yyn0', no_load_loss_w: 100,  load_loss_w: '910/870',   no_load_current_pct: 0.5,  noise_db: 43, impedance_pct: 4.0, spec_ab_mm: '400×400', size_mm: '850×680×960',   weight_kg: 420 },
        { capacity_kva: 80,   hv_kv: '6–11', lv_kv: 0.4, freq_hz: 50, connection: 'Dyn11 / Yyn0', no_load_loss_w: 130,  load_loss_w: '1310/1250', no_load_current_pct: 0.45, noise_db: 44, impedance_pct: 4.0, spec_ab_mm: '400×400', size_mm: '870×700×1010',  weight_kg: 520 },
        { capacity_kva: 100,  hv_kv: '6–11', lv_kv: 0.4, freq_hz: 50, connection: 'Dyn11 / Yyn0', no_load_loss_w: 150,  load_loss_w: '1580/1500', no_load_current_pct: 0.45, noise_db: 44, impedance_pct: 4.0, spec_ab_mm: '400×400', size_mm: '900×720×1020',  weight_kg: 580 },
        { capacity_kva: 160,  hv_kv: '6–11', lv_kv: 0.4, freq_hz: 50, connection: 'Dyn11 / Yyn0', no_load_loss_w: 200,  load_loss_w: '2310/2200', no_load_current_pct: 0.4,  noise_db: 46, impedance_pct: 4.0, spec_ab_mm: '550×550', size_mm: '1190×770×1090', weight_kg: 790 },
        { capacity_kva: 200,  hv_kv: '6–11', lv_kv: 0.4, freq_hz: 50, connection: 'Dyn11 / Yyn0', no_load_loss_w: 240,  load_loss_w: '2730/2600', no_load_current_pct: 0.4,  noise_db: 47, impedance_pct: 4.0, spec_ab_mm: '550×550', size_mm: '1260×850×1120', weight_kg: 880 },
        { capacity_kva: 250,  hv_kv: '6–11', lv_kv: 0.4, freq_hz: 50, connection: 'Dyn11 / Yyn0', no_load_loss_w: 290,  load_loss_w: '3200/3050', no_load_current_pct: 0.35, noise_db: 48, impedance_pct: 4.0, spec_ab_mm: '550×550', size_mm: '1300×860×1140', weight_kg: 1020 },
        { capacity_kva: 315,  hv_kv: '6–11', lv_kv: 0.4, freq_hz: 50, connection: 'Dyn11 / Yyn0', no_load_loss_w: 340,  load_loss_w: '3830/3650', no_load_current_pct: 0.35, noise_db: 48, impedance_pct: 4.0, spec_ab_mm: '660×660', size_mm: '1370×910×1160', weight_kg: 1220 },
        { capacity_kva: 400,  hv_kv: '6–11', lv_kv: 0.4, freq_hz: 50, connection: 'Dyn11 / Yyn0', no_load_loss_w: 410,  load_loss_w: '4520/4300', no_load_current_pct: 0.35, noise_db: 48, impedance_pct: 4.0, spec_ab_mm: '660×660', size_mm: '1400×920×1220', weight_kg: 1430 },
        { capacity_kva: 500,  hv_kv: '6–11', lv_kv: 0.4, freq_hz: 50, connection: 'Dyn11 / Yyn0', no_load_loss_w: 480,  load_loss_w: '5410/5150', no_load_current_pct: 0.3,  noise_db: 49, impedance_pct: 4.0, spec_ab_mm: '660×660', size_mm: '1530×1000×1280', weight_kg: 1730 },
        { capacity_kva: 630,  hv_kv: '6–11', lv_kv: 0.4, freq_hz: 50, connection: 'Dyn11 / Yyn0', no_load_loss_w: 570,  load_loss_w: 6200,        no_load_current_pct: 0.25, noise_db: 49, impedance_pct: 4.5, spec_ab_mm: '660×660', size_mm: '1610×1060×1320', weight_kg: 2100 },
        { capacity_kva: 800,  hv_kv: '6–11', lv_kv: 0.4, freq_hz: 50, connection: 'Dyn11 / Yyn0', no_load_loss_w: 700,  load_loss_w: 7500,        no_load_current_pct: 0.18, noise_db: 50, impedance_pct: 4.5, spec_ab_mm: '660×820', size_mm: '1670×1120×1380', weight_kg: 2480 },
        { capacity_kva: 1000, hv_kv: '6–11', lv_kv: 0.4, freq_hz: 50, connection: 'Dyn11 / Yyn0', no_load_loss_w: 830,  load_loss_w: 10300,       no_load_current_pct: 0.17, noise_db: 50, impedance_pct: 4.5, spec_ab_mm: '660×820', size_mm: '1720×1160×1400', weight_kg: 2880 },
        { capacity_kva: 1250, hv_kv: '6–11', lv_kv: 0.4, freq_hz: 50, connection: 'Dyn11 / Yyn0', no_load_loss_w: 970,  load_loss_w: 12000,       no_load_current_pct: 0.17, noise_db: 52, impedance_pct: 4.5, spec_ab_mm: '660×820', size_mm: '1770×1180×1500', weight_kg: 3500 },
        { capacity_kva: 1600, hv_kv: '6–11', lv_kv: 0.4, freq_hz: 50, connection: 'Dyn11 / Yyn0', no_load_loss_w: 1170, load_loss_w: 14500,       no_load_current_pct: 0.16, noise_db: 52, impedance_pct: 4.5, spec_ab_mm: '820×1070', size_mm: '1860×1240×1600', weight_kg: 4130 },
        { capacity_kva: 2000, hv_kv: '6–11', lv_kv: 0.4, freq_hz: 50, connection: 'Dyn11 / Yyn0', no_load_loss_w: 1360, load_loss_w: 18300,       no_load_current_pct: 0.16, noise_db: 54, impedance_pct: 5.0, spec_ab_mm: '820×1070', size_mm: '1950×1320×1720', weight_kg: 5420 },
        { capacity_kva: 2500, hv_kv: '6–11', lv_kv: 0.4, freq_hz: 50, connection: 'Dyn11 / Yyn0', no_load_loss_w: 1600, load_loss_w: 21200,       no_load_current_pct: 0.15, noise_db: 54, impedance_pct: 5.0, spec_ab_mm: '820×1070', size_mm: '2070×1400×1800', weight_kg: 6500 },
      ],
      note: '以上为 6–11 kV 油浸式配电变压器的典型参考参数，二次电压为 0.4 kV，联结组为 Dyn11 / Yyn0。',
    },
  },
  {
    ...
    seoDescription: 'Dry type transformers for indoor commercial, industrial and infrastructure applications, with project-specific voltage and enclosure options.',
    ...
    descriptionBullets: [
      ...
      { zh: '优化低噪音设计，实际声级取决于额定容量、外壳和冷却配置。', en: 'Optimized low-noise design; actual sound level depends on rated capacity, enclosure and cooling configuration.' },
    ...
    quotationRequirements: [...quotationRequirements],
    faq: createProductFaq('Dry Type Transformer', 'IEC 60076-11 or applicable project requirements'),
    relatedProductSlugs: ['oil-immersed-distribution-transformer', 'compact-substation', 'power-transformer'],
    technicalDocuments: [...technicalDocuments],
    detailedSpecTable: {
      columns: [
        { key: 'capacity_kva', label: '容量', unit: 'kVA' },
      ...
      note: '以上为 10 kV 级 SCB 系列干式变压器的典型参考参数。高压选项：6 / 6.3 / 6.6 / 10 / 10.5 / 11 kV，低压：0.4 kV，可选 IP20 防护外壳。',
    },
  },
  {
    ...
    seoDescription: 'Single-phase pole mounted transformers for overhead utility distribution, rural electrification and project-specific network requirements.',
    ...
    quotationRequirements: [...quotationRequirements],
    faq: createProductFaq('Pole Mounted Transformer', 'ANSI / IEEE or applicable utility requirements'),
    relatedProductSlugs: ['oil-immersed-distribution-transformer', 'compact-substation', 'dry-type-transformer'],
    technicalDocuments: [...technicalDocuments],
    detailedSpecTable: {
      columns: [
        { key: 'label', label: '参数' },
        { key: 'value', label: '典型规格' },
      ],
      rows: [
        { label: '容量 / Capacity', value: '5–167 kVA' },
        { label: '二次电压 / Secondary Voltage', value: '120/240 V' },
        { label: '频率 / Frequency', value: '60 Hz' },
        { label: '相数 / Phase', value: 'Single Phase' },
        { label: '冷却方式 / Cooling', value: 'ONAN' },
        { label: '标准 / Standard', value: 'ANSI / IEEE' },
      ],
      note: '以上为单相柱上式配电变压器的典型参考参数。',
    },
  },
  {
    ...
    seoDescription: 'Oil immersed power transformers for substations, industrial power systems and project-specific transmission or distribution applications.',
    ...
    productDescription: '用于变电站、工业供电和电力工程项目的油浸式电力变压器，额定电压、容量及技术配置按项目要求确定。',
    descriptionBullets: [
      { zh: '额定电压按项目要求定制', en: 'Rated Voltage: Customized According to Project Requirements' },
      { zh: '额定容量按项目要求定制', en: 'Rated Capacity: Customized According to Project Requirements' },
      { zh: '频率为 50 Hz 或 60 Hz，以项目要求为准', en: 'Frequency: 50 Hz or 60 Hz, Subject to Project Requirements' },
    ...
    relatedProductSlugs: ['high-voltage-power-transformer', 'oil-immersed-distribution-transformer', 'compact-substation'],
    technicalDocuments: [...technicalDocuments],
  },
  {
    ...
    seoDescription: 'High voltage power transformers for utility substations, industrial grid connections and large infrastructure power projects.',
    ...
    productDescription: '110 kV 三绕组有载调压电力变压器，典型容量范围为 6.3–63 MVA，额定频率为 50 Hz。',
    descriptionBullets: [
    ...
    quotationRequirements: [...quotationRequirements],
    faq: createProductFaq('High Voltage Power Transformer', 'IEC 60076 and applicable grid or project requirements'),
    relatedProductSlugs: ['power-transformer', 'compact-substation', 'oil-immersed-distribution-transformer'],
    technicalDocuments: [...technicalDocuments],
    detailedSpecTable: {
      columns: [
        { key: 'label', label: '参数' },
      ...
      rows: [
        { label: '电压等级 / Voltage Class', value: '110 kV' },
        { label: '容量 / Capacity', value: '6.3–63 MVA' },
        { label: '频率 / Frequency', value: '50 Hz' },
        { label: '冷却方式 / Cooling', value: 'ONAN / ONAF' },
        { label: '联结组 / Vector Group', value: 'YNyn0d11' },
        { label: '标准 / Standard', value: 'IEC 60076' },
      ],
      note: '以上为 110 kV 三绕组有载调压电力变压器的典型参考参数。',
    },
  },
  {
    ...
    seoDescription: 'Compact substations integrating high-voltage, transformer and low-voltage sections for industrial, commercial and infrastructure projects.',
    ...
    productDescription: '适用于工业、商业、基础设施及新能源项目的一体化配电解决方案，符合 IEC 62271-202 与 IEC 60076。',
    descriptionBullets: [
      { zh: '高压、变压器和低压单元集成设计', en: 'Integrated HV, Transformer and LV Compartments' },
      ...
      { zh: '外壳、防护等级和电气配置均可定制', en: 'Customizable Enclosure, Protection and Electrical Configuration' },
    ],
    applications: [
    ...
    quotationRequirements: [...quotationRequirements],
    faq: createProductFaq('Compact Substation', 'IEC 62271-202, IEC 60076 or applicable project requirements'),
    relatedProductSlugs: ['oil-immersed-distribution-transformer', 'dry-type-transformer', 'power-transformer'],
    technicalDocuments: [...technicalDocuments],
    detailedSpecTable: {
      columns: [
        { key: 'label', label: '参数' },
      ...
      rows: [
        { label: '额定容量',     value: '315 kVA / 500 kVA / 630 kVA / 800 kVA / 1000 kVA / 1250 kVA / 1600 kVA / 2500 kVA' },
        { label: '高压侧电压',   value: '6 kV、10 kV、11 kV、20 kV、33 kV、35 kV 或定制' },
        { label: '低压侧电压',   value: '0.4 kV 或定制' },
        { label: '频率',         value: '50 Hz / 60 Hz' },
        { label: '变压器类型',   value: '油浸式或干式' },
        { label: '防护等级',     value: 'IP23–IP54 或定制' },
        { label: '外壳材料',     value: '彩钢板、不锈钢或复合材料' },
        { label: '安装高度',     value: '≤1000 m 或定制' },
        { label: '箱体颜色',     value: '绿色、灰色或项目定制' },
        { label: '执行标准',     value: 'IEC 62271-202 / IEC 60076' },
      ],
      note: '高压开关、变压器、低压配电及箱体配置可根据项目单线图和现场条件定制。',
    },
  },
]
