...
export const products: Product[] = [
  ...
  },
  {
    ...
    icon: Zap,
    title: '110 kV三绕组有载调压电力变压器典型参数',
    titleEn: 'Typical Parameters for 110 kV Three-Winding OLTC Power Transformer',
  ...
  },
  {
    ...
    icon: Radio,
    title: '单相柱上式配电变压器',
    titleEn: 'Single-Phase Pole-Mounted Distribution Transformer',
